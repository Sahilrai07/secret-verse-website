...
const EditForm = ({ data }: IEditProps) => {
  const [imagePreviewUrl, setImagePreviewUrl] = useState<string>(""); // local preview
  const [imageValue, setImageValue] = useState<string>(data.image); // final image key or URL
